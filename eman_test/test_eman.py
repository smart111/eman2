...
def main():
	...
	parser.add_argument("--ref", type=str,help="reference results", default="data/results")
	parser.add_argument("--testqt", type=int,help="test qt (0/1). default is 1.", default=0)
	parser.add_argument("--testtheano", type=int,help="test theano (0/1). default is 1.", default=0)
	parser.add_argument("--threads", type=int,help="thread", default=1)
