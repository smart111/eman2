...
from emglobjects import EM3DModel, Camera, Camera2, EMViewportDepthTools2, EMGLProjectionViewMatrices, get_default_gl_colors
...
class EMSymViewerWidget(QtOpenGL.QGLWidget, EMGLProjectionViewMatrices):
